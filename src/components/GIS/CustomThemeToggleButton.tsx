...
const CustomThemeToggleButton: React.FC<{ isExpanded?: boolean; transitionDelay?: string }> = ({ 
  isExpanded = true, 
  transitionDelay = '0ms' 
}) => {
  // Read initial theme state from DOM using the app's theme system
...
// Set displayName for Menu component recognition
CustomThemeToggleButton.displayName = 'CustomThemeToggleButton';
